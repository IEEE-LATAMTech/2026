...
export const trackCards = [
  ...
  },
  {
    ...
    speakers: [
      ...
      {
        name: "Estefanía Delgado Castillo",
        role: "Computer Science Student, Tecnológico de Costa Rica",
        image: "/images/speakers/estefania-delgado-castillo.png",
        bio: "Computer Science student at TEC. She currently works as a software developer for the Centro Nacional de Detección Temprana de Cáncer Gástrico (CNDTCG), contributing to the digital management of clinical workflows and information through AI-supported development practices. She is also a researcher with the Pattern Recognition and Machine Learning (PARMA-Group) at TEC.\n\nShe is interested in developing technology-driven solutions that respond to real needs and serve communities. Her research focuses on applied machine learning, responsible AI, and the use of technology to address environmental and/or social challenges.",
      },
      {
